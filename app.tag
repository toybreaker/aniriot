    ...
    <nav class="years_links_wrap">
        ...
        <div class="logo only_home">
          <div class="logo_svg_wrap">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 545.9 533.8">
              <style>
        ...
        <div class="years_links_scroller">
          <div class="years_links">
            <a each={ data } href="#{ animal }">{ id }</a>
          </div>
        </div>

        <div class="help only_home">tap birth year</div>
    </nav>
